...
POC_PROMPT = os.environ.get("ELEVENLABS_POC_PROMPT", "You are a helpful customer service agent at Enpal.")
POC_FIRST_MESSAGE = os.environ.get("ELEVENLABS_POC_FIRST_MESSAGE", "Hallo Benedikt, grüß dich.")
